...
class Topic
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Forum\Tag", inversedBy="topics")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Auth\User", inversedBy="topics")
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Forum\Message", mappedBy="topic")
     */
    private Collection $messages;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Forum\Message")
